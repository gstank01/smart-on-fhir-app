    ...
    if (urlParams.has("iss") && urlParams.has("launch")) {
        ...
        statusDiv.innerHTML = ` 
            <div class="inspection-card">
                ...
                <p class="inspect-label">2. Extracted FHIR Endpoint(iss): here we display the endpoint extracted from the launch URL</p>
                <code class="inspect-code iss">${fhirServerUrl}</code>
                <p class="inspect-label">3 Extracted Session Token (launch): this is the launch token that we will exchange for an authorization key</p>
